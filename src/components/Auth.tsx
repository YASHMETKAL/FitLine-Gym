  ...
  const handleEmailAuth = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (err instanceof Error) {
        ...
        } else if (errorCode === "auth/email-already-in-use" || errorMsg.includes("email-already-in-use")) {
        ...
        } else if (errorCode === "auth/wrong-password" || errorMsg.includes("wrong-password")) {
  ...
  const handleGoogleAuth = async () => {
    ...
    try {
      ...
      if (err instanceof Error) {
        ...
        } else if (errorCode === "auth/unauthorized-domain" || errorCode === "auth/unauthorized" || errorMsg.includes("unauthorized")) {
          const currentDomain = window.location.hostname;
          errorMessage = `This domain (${currentDomain}) is not authorized for Google Sign-In. Please add it to Firebase Console → Authentication → Settings → Authorized domains.`;
        } else if (errorCode === "auth/popup-closed-by-user" || errorMsg.includes("popup-closed")) {
